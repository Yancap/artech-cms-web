[X] Regular o roteamento da página para realizar as verificações de login
[x] Criar o tratamento de erro com mensagens estilo modal, como no FIGMa
[x] Criar o modal a nivel componanente
[x] Fazer as lógicas para o modal (fazer uma lógica que permita diversos modals de erro)
[x] Refatorar e testar para ver se ta tudo ok
[] Criar os endpoints de ADM
- [x] editar o microsservice para retornar apenas os manager do tipo author
- [x] rebuildar o microservice de CMS para incluir as novas regras
- [x] verificar o problema da conexão com mysql do microservice
- [x] botão de excluir do author
- [x] botão de excluir do articles
[x] chamada a API de comentarios
